...
old_block = '''def _build_pick_pool(lam, mu, home, away, ht_ft_probs, league, market_odds=None):
...
new_block = '''def _raw_candidates(lam, mu, home, away, ht_ft_probs, market_odds=None):
...
assert count == 1, f"daily pick logic anchor count: {count} (очаквано 1)"
...
print("OK - top_pick_with_code()/top_picks_with_code() сега минават през pick_selection.rank_candidates()")
