...
def main():
    ...
    with open("england_premier_league_matches.csv", "w", newline="", encoding="utf-8") as csvfile:
    ...
    print(f"\nОбщо записани {len(all_matches)} мача в england_premier_league_matches.csv")
