...
history = pd.read_csv(f"{COUNTRY_NAME.lower()}_full_history.csv")
stats = pd.read_csv(f"{COUNTRY_NAME.lower()}_match_statistics.csv")
...
output_path = f"{COUNTRY_NAME.lower()}_merged_full.csv"
merged.to_csv(output_path, index=False)
print(f"{COUNTRY_NAME}: {len(merged)} мача записани в {output_path}")
